...
import 'package:styria_flutter_web/layouts/links/links_main_layout.dart';
      ...
      return MainLayout(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: LinksMainLayout(showBreadcrumbs: false),
            ),
          ],
        ),
      );
    }
    return MainLayout(child: LinksMainLayout(showBreadcrumbs: true));
  }
}
