...
import 'package:styria_flutter_web/layouts/time_report/time_report_layout.dart';
import 'package:styria_flutter_web/shared/providers/mobile_provider.dart';

class TimeReportPage extends ConsumerWidget {
    ...
    if (isMobile) {
      return MainLayout(
        ...
        child: Scaffold(
          ...
          body: const TimeReportLayout(showBreadcrumbs: false),
        ),
      );
    }

    return MainLayout(
      child: const TimeReportLayout(showBreadcrumbs: true),
    );
  }
}
