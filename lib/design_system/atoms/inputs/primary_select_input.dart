...
class PrimarySelectInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ProviderScope(
      ...
      child: _PrimarySelectInputContent(
...
class _PrimarySelectInputContent extends ConsumerWidget {
  final String initialValue;
  final List<String> items;
  final String labelText;

  const _PrimarySelectInputContent({
    required this.initialValue,
    required this.items,
    required this.labelText,
  });
    ...
    return DropdownButtonFormField(
      ...
      onChanged: (String? newValue) {
        if (newValue != null) {
          ...
          ref.read(selectedChannelValueProvider.notifier).state = newValue;
        }
      },
